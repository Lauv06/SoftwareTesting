  ...
  <div id="triangleDe">
    <el-collapse v-model="activeNames" accordion>
      <el-collapse-item name="1">
        ...
        <el-form status-icon label-width="120px" ref="edges" :model="edges" :rules="rules" style="width: 500px;margin: auto">
          <el-form-item label="第一条边长度" prop="edge1">
            <el-input v-model.number="edges.edge1"></el-input>
          </el-form-item>
          <el-form-item label="第二条边长度" prop="edge2">
            <el-input v-model.number="edges.edge2"></el-input>
          </el-form-item>
          <el-form-item label="第三条边长度" prop="edge3">
            <el-input v-model.number="edges.edge3"></el-input>
          </el-form-item>
          <el-form-item>
            <el-button type="primary" @click="submitForm('edges')">提交</el-button>
            <el-button @click="resetForm('edges')">重置</el-button>
          </el-form-item>
          <el-form-item label="三角形类型">
...
export default {
  ...
  methods: {
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          this.$http.get('http://127.0.0.1:8000/api/triangle', {params: this.edges})
              .then((response) => {
    ...
    startTesting() {
      this.$http.get('http://127.0.0.1:8000/api/triangleTest',
